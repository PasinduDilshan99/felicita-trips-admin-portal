...
export const PRIVILEGE_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
export const PRIVILEGE_CREATE_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
export const PRIVILEGE_UPDATE_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
export const ROLE_VIEW_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
export const ROLE_CREATE_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
export const ROLE_UPDATE_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
export const ROLE_UPDATE_PRIVILEGE_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
