...
export const ACTIVITY_SCHEDULE_UPDATE_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
export const TOUR_SCHEDULE_VIEW_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
export const TOUR_SCHEDULE_UPDATE_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
export const PACKAGE_SCHEDULE_VIEW_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
export const PACKAGE_SCHEDULE_UPDATE_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
export const SEASON_UPDATE_STATUS_OPTIONS = [...COMMON_STATUS_OPTIONS];
