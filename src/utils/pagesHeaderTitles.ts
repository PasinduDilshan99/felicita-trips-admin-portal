...
export const PRIVILEGE_MANAGEMENT_PAGE_TITLE = "Privileges Management";
export const PRIVILEGE_VIEW_PAGE_TITLE = "Privileges View";
export const PRIVILEGE_DETAILS_VIEW_PAGE_TITLE = "Privilege Details View";
export const PRIVILEGE_CREATE_PAGE_TITLE = "Privilege Create";
export const PRIVILEGE_UPDATE_PAGE_TITLE = "Privilege Update";
export const PRIVILEGE_TERMINATE_PAGE_TITLE = "Privilege Terminate";

export const ROLES_MANAGEMENT_PAGE_TITLE = "Roles Management";
export const ROLES_VIEW_PAGE_TITLE = "Roles View";
export const ROLES_DETAILS_VIEW_PAGE_TITLE = "Role Details View";
export const ROLE_CREATE_PAGE_TITLE = "Role Create";
export const ROLE_UPDATE_PAGE_TITLE = "Role Update";
export const ROLE_TERMINATE_PAGE_TITLE = "Role Terminate";

export const EMPLOYEE_PAGE_MANAGEMENT_PAGE_TITLE = "Employee Management";
