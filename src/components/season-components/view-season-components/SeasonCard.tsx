...
import { SeasonCardProps, SeasonImage } from "@/types/season-types";
...
const SeasonCard: React.FC<SeasonCardProps> = ({ season, onImageClick }) => {
        ...
        >
          ...
          {standardName && (
            <motion.p
              ...
              style={{ color: theme.textSecondary }}
            >
              <span className="font-semibold">Standard:</span> {standardName}
            </motion.p>
          )}
          ...
          {localName && (
            <motion.p
              ...
              style={{ color: theme.textSecondary }}
            >
              <span className="font-semibold">Local:</span> {localName}
            </motion.p>
          )}
