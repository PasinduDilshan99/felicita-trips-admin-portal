...
import { TourCategoryReadOnlyDetailsProps } from "@/types/tour-category-types";
import ImageModal from "@/components/common-components/ImageModal";
import { ImageModalImage } from "@/types/common-components-types";
import { cardVariants, sectionVariants } from "@/app/animations/variants";

export const TourCategoryReadOnlyDetails: React.FC<
  TourCategoryReadOnlyDetailsProps
> = ({
  category,
  allTours,
  loadingTours,
