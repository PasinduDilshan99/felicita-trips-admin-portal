...
import { StatItem, TourCategoryStatsProps } from "@/types/tour-category-types";
import { containerVariants, statCardVariants, valueVariants } from "@/app/animations/variants";
import { hexToRgba } from "@/utils/functions";

export const TourCategoryStats: React.FC<TourCategoryStatsProps> = ({
  categoryDetails,
}) => {
  ...
  const primaryToursCount = categoryDetails.tours.filter(
    (tour) => tour.primaryCategory,
  ).length;
