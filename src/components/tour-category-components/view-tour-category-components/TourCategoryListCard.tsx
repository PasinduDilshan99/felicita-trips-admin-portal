// components/tour-categories-components/view-tour-category-components/TourCategoryListCard.tsx
"use client";
...
interface TourCategoryListCardProps {
  category: TourCategoryListItem;
  onImageClick?: (imageIndex: number) => void;
}

const TourCategoryListCard: React.FC<TourCategoryListCardProps> = ({ category, onImageClick }) => {
  ...
  const description = getSafeString(category?.description, "No description available");
