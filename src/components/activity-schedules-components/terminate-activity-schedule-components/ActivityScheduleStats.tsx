// components/activity-schedules-components/terminate-activity-schedule-components/ActivityScheduleStats.tsx
"use client";

import React from "react";
import { motion, type Variants } from "framer-motion";
import { Clock, Calendar, DollarSign, Users, Activity, AlertCircle, MapPin } from "lucide-react";
...
interface ActivityScheduleStatsProps {
...
export const ActivityScheduleStats: React.FC<ActivityScheduleStatsProps> = ({ scheduleDetails }) => {
        ...
        {statItems.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              {(item.label === "Schedule Status" || item.label === "Activity Status") && (
                <motion.div
