// components/tour-categories-components/tour-category-details-view-components/TourCategoryOverview.tsx
"use client";
...
interface TourCategoryOverviewProps {
  name: string;
  description: string;
  color: string | null;
...
export const TourCategoryOverview: React.FC<TourCategoryOverviewProps> = ({
  name,
  description,
  color,
  hoverColor,
