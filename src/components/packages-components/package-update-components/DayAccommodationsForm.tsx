// components/packages-components/update-package-components/DayAccommodationsForm.tsx
"use client";
...
import { AddDayAccommodationRequest, UpdateDayAccommodationRequest } from "@/types/package-types";
...
const MealToggle: React.FC<{
  ...
  theme: any;
}> = ({ label, icon, enabled, description, onToggle, onDescriptionChange, theme }) => (
  <div className="p-3 rounded-lg" style={{ backgroundColor: `${theme.border}10` }}>
    <div className="flex items-center justify-between mb-2">
      <label className="flex items-center gap-2 cursor-pointer">
        ...
        />
        <span className="flex items-center gap-1.5 text-sm" style={{ color: theme.text }}>
          {icon}
          {label}
        </span>
      </label>
...
export const DayAccommodationsForm: React.FC<DayAccommodationsFormProps> = ({
  ...
  const [editingDay, setEditingDay] = useState<DayAccommodationResponse | null>(null);
  ...
  const isDayUpdated = (id: number) => updatedDayAccommodations.some(u => u.packageDayAccommodationId === id);
  const getDayUpdate = (id: number) => updatedDayAccommodations.find(u => u.packageDayAccommodationId === id);
  ...
  const handleEditClick = (day: DayAccommodationResponse) => {
    ...
    setEditDayData({
      ...
      breakfastDescription: update?.breakfastDescription ?? day.breakfastDescription,
      ...
      morningTeaDescription: update?.morningTeaDescription ?? day.morningTeaDescription,
      eveningTea: update?.eveningTea ?? day.eveningTea,
      eveningTeaDescription: update?.eveningTeaDescription ?? day.eveningTeaDescription,
  ...
  const sortedDays = [...dayAccommodations].sort((a, b) => a.dayNumber - b.dayNumber);
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewDayData({ ...newDayData, dayNumber: parseInt(e.target.value) })}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewDayData({ ...newDayData, hotelId: parseInt(e.target.value) })}
                      className="w-full px-3 py-2 rounded-lg border-2 text-sm"
                      style={{ ...fieldBase, borderColor: theme.border }}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewDayData({ ...newDayData, transportId: parseInt(e.target.value) })}
                      className="w-full px-3 py-2 rounded-lg border-2 text-sm"
                      style={{ ...fieldBase, borderColor: theme.border }}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <MealToggle
                      ...
                      onToggle={(enabled) => setNewDayData({ ...newDayData, breakfast: enabled })}
                      onDescriptionChange={(desc) => setNewDayData({ ...newDayData, breakfastDescription: desc })}
                      theme={theme}
                    />
                    <MealToggle
                      label="Morning Tea"
                      ...
                      onToggle={(enabled) => setNewDayData({ ...newDayData, morningTea: enabled })}
                      onDescriptionChange={(desc) => setNewDayData({ ...newDayData, morningTeaDescription: desc })}
                      theme={theme}
                    />
                    <MealToggle
                      label="Lunch"
                      ...
                      onToggle={(enabled) => setNewDayData({ ...newDayData, lunch: enabled })}
                      onDescriptionChange={(desc) => setNewDayData({ ...newDayData, lunchDescription: desc })}
                      theme={theme}
                    />
                    <MealToggle
                      label="Evening Tea"
                      ...
                      onToggle={(enabled) => setNewDayData({ ...newDayData, eveningTea: enabled })}
                      onDescriptionChange={(desc) => setNewDayData({ ...newDayData, eveningTeaDescription: desc })}
                      theme={theme}
                    />
                    <MealToggle
                      label="Dinner"
                      ...
                      onToggle={(enabled) => setNewDayData({ ...newDayData, dinner: enabled })}
                      onDescriptionChange={(desc) => setNewDayData({ ...newDayData, dinnerDescription: desc })}
                      theme={theme}
                    />
                    <MealToggle
                      label="Snacks"
                      ...
                      onToggle={(enabled) => setNewDayData({ ...newDayData, snacks: enabled })}
                      onDescriptionChange={(desc) => setNewDayData({ ...newDayData, snackNote: desc })}
                      theme={theme}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setNewDayData({ ...newDayData, otherNotes: e.target.value })}
                      rows={2}
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setEditDayData({ ...editDayData, dayNumber: parseInt(e.target.value) })}
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => setEditDayData({ ...editDayData, status: e.target.value as "ACTIVE" | "INACTIVE" })}
                          className="w-full px-3 py-2 rounded-lg border-2"
                          style={{ ...fieldBase, borderColor: theme.border }}
                        >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setEditDayData({ ...editDayData, hotelId: parseInt(e.target.value) })}
                        className="w-full px-3 py-2 rounded-lg border-2"
                        style={{ ...fieldBase, borderColor: theme.border }}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setEditDayData({ ...editDayData, transportId: parseInt(e.target.value) })}
                        className="w-full px-3 py-2 rounded-lg border-2"
                        style={{ ...fieldBase, borderColor: theme.border }}
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <MealToggle
                        ...
                        onToggle={(enabled) => setEditDayData({ ...editDayData, breakfast: enabled })}
                        onDescriptionChange={(desc) => setEditDayData({ ...editDayData, breakfastDescription: desc })}
                        theme={theme}
                      />
                      <MealToggle
                        label="Morning Tea"
                        ...
                        onToggle={(enabled) => setEditDayData({ ...editDayData, morningTea: enabled })}
                        onDescriptionChange={(desc) => setEditDayData({ ...editDayData, morningTeaDescription: desc })}
                        theme={theme}
                      />
                      <MealToggle
                        label="Lunch"
                        ...
                        onToggle={(enabled) => setEditDayData({ ...editDayData, lunch: enabled })}
                        onDescriptionChange={(desc) => setEditDayData({ ...editDayData, lunchDescription: desc })}
                        theme={theme}
                      />
                      <MealToggle
                        label="Evening Tea"
                        ...
                        onToggle={(enabled) => setEditDayData({ ...editDayData, eveningTea: enabled })}
                        onDescriptionChange={(desc) => setEditDayData({ ...editDayData, eveningTeaDescription: desc })}
                        theme={theme}
                      />
                      <MealToggle
                        label="Dinner"
                        ...
                        onToggle={(enabled) => setEditDayData({ ...editDayData, dinner: enabled })}
                        onDescriptionChange={(desc) => setEditDayData({ ...editDayData, dinnerDescription: desc })}
                        theme={theme}
                      />
                      <MealToggle
                        label="Snacks"
                        ...
                        onToggle={(enabled) => setEditDayData({ ...editDayData, snacks: enabled })}
                        onDescriptionChange={(desc) => setEditDayData({ ...editDayData, snackNote: desc })}
                        theme={theme}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => setEditDayData({ ...editDayData, otherNotes: e.target.value })}
                        rows={2}
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: isDayExpanded ? `${theme.primary}05` : "transparent",
                    }}
                  >
                    <div className="flex items-center gap-3">
                      <div
                      ...
                      <div>
                        ...
                        <p className="text-xs" style={{ color: theme.textSecondary }}>
                          Hotel: {day.hotelName} | Transport: {day.vehicleTypeName}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          onRemoveDayAccommodation(day.packageDayAccommodationId);
                        }}
                        className="p-1 rounded hover:bg-black/10"
                      >
                        <Trash2 className="w-3.5 h-3.5" style={{ color: theme.error }} />
                      </button>
                      <ChevronRight
                        className="w-4 h-4 transition-transform"
                        style={{ transform: isDayExpanded ? "rotate(90deg)" : "none", color: theme.textSecondary }}
                      />
                    </div>
                  </div>
                    ...
                    <div className="px-4 pb-4 space-y-3">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="p-3 rounded-lg" style={{ backgroundColor: `${theme.border}10` }}>
                          ...
                          <p className="text-sm"><strong>Name:</strong> {day.hotelName}</p>
                          <p className="text-sm"><strong>Description:</strong> {day.hotelDescription}</p>
                          <p className="text-sm"><strong>Location:</strong> {day.hotelLocation}</p>
                          {day.hotelWebsite && (
                            <p className="text-sm"><strong>Website:</strong> <a href={day.hotelWebsite} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">{day.hotelWebsite}</a></p>
                          )}
                        </div>
                        <div className="p-3 rounded-lg" style={{ backgroundColor: `${theme.border}10` }}>
                          <h4 className="text-xs font-semibold mb-2 flex items-center gap-1" style={{ color: theme.textSecondary }}>
                          ...
                          <p className="text-sm"><strong>Vehicle:</strong> {day.vehicleTypeName}</p>
                          <p className="text-sm"><strong>Model:</strong> {day.vehicleModel}</p>
                          <p className="text-sm"><strong>Registration:</strong> {day.vehicleRegistrationNumber}</p>
                          <p className="text-sm"><strong>Seats:</strong> {day.seatCapacity} | <strong>AC:</strong> {day.airCondition ? "Yes" : "No"}</p>
                        </div>
                      </div>

                      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                        {(update?.breakfast ?? day.breakfast) && (
                          <div className="p-2 rounded-lg text-center" style={{ backgroundColor: `${theme.success}10` }}>
                            <Coffee className="w-4 h-4 mx-auto mb-1" style={{ color: theme.success }} />
                            <p className="text-xs font-medium">Breakfast</p>
                            {(update?.breakfastDescription ?? day.breakfastDescription) && (
                              <p className="text-xs mt-1 opacity-75">{(update?.breakfastDescription ?? day.breakfastDescription)}</p>
                            )}
                          </div>
                        )}
                        {(update?.morningTea ?? day.morningTea) && (
                          <div className="p-2 rounded-lg text-center" style={{ backgroundColor: `${theme.success}10` }}>
                            <Sun className="w-4 h-4 mx-auto mb-1" style={{ color: theme.success }} />
                            <p className="text-xs font-medium">Morning Tea</p>
                            {(update?.morningTeaDescription ?? day.morningTeaDescription) && (
                              <p className="text-xs mt-1 opacity-75">{(update?.morningTeaDescription ?? day.morningTeaDescription)}</p>
                            )}
                          </div>
                        )}
                        {(update?.lunch ?? day.lunch) && (
                          <div className="p-2 rounded-lg text-center" style={{ backgroundColor: `${theme.success}10` }}>
                            <Utensils className="w-4 h-4 mx-auto mb-1" style={{ color: theme.success }} />
                            <p className="text-xs font-medium">Lunch</p>
                            {(update?.lunchDescription ?? day.lunchDescription) && (
                              <p className="text-xs mt-1 opacity-75">{(update?.lunchDescription ?? day.lunchDescription)}</p>
                            )}
                          </div>
                        )}
                        {(update?.eveningTea ?? day.eveningTea) && (
                          <div className="p-2 rounded-lg text-center" style={{ backgroundColor: `${theme.success}10` }}>
                            ...
                            {(update?.eveningTeaDescription ?? day.eveningTeaDescription) && (
                              <p className="text-xs mt-1 opacity-75">{(update?.eveningTeaDescription ?? day.eveningTeaDescription)}</p>
                            )}
                          </div>
                        )}
                        {(update?.dinner ?? day.dinner) && (
                          <div className="p-2 rounded-lg text-center" style={{ backgroundColor: `${theme.success}10` }}>
                            <Moon className="w-4 h-4 mx-auto mb-1" style={{ color: theme.success }} />
                            <p className="text-xs font-medium">Dinner</p>
                            {(update?.dinnerDescription ?? day.dinnerDescription) && (
                              <p className="text-xs mt-1 opacity-75">{(update?.dinnerDescription ?? day.dinnerDescription)}</p>
                            )}
                          </div>
                        )}
                        {(update?.snacks ?? day.snacks) && (
                          <div className="p-2 rounded-lg text-center" style={{ backgroundColor: `${theme.success}10` }}>
                            <Cake className="w-4 h-4 mx-auto mb-1" style={{ color: theme.success }} />
                            <p className="text-xs font-medium">Snacks</p>
                            {(update?.snackNote ?? day.snackNote) && (
                              <p className="text-xs mt-1 opacity-75">{(update?.snackNote ?? day.snackNote)}</p>
                            )}
                          </div>
                        )}
                      </div>
                      ...
                      {(update?.otherNotes ?? day.otherNotes) && (
                        <div className="p-3 rounded-lg" style={{ backgroundColor: `${theme.warning}10` }}>
                          <p className="text-xs italic">📝 {(update?.otherNotes ?? day.otherNotes)}</p>
                        </div>
                      )}
                    </div>
                  )}
            ...
            <div className="mt-4 pt-4 border-t" style={{ borderColor: theme.border }}>
              ...
              <div className="space-y-2">
                {addedDayAccommodations.map((day, idx) => (
                  ...
                  >
                    <Hotel className="w-3.5 h-3.5" style={{ color: theme.success }} />
                    <span className="text-sm" style={{ color: theme.text }}>
                      Day {day.dayNumber}: Hotel ID {day.hotelId}, Transport ID {day.transportId}
                    </span>
                    <span className="ml-auto text-xs text-white px-2 py-0.5 rounded-full" style={{ backgroundColor: theme.success }}>
                      New
                    </span>
                  </div>
                ))}
