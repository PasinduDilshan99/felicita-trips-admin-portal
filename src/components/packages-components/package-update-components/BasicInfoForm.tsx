        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <motion.div variants={fieldVariants} className="lg:col-span-2">
            ...
            <input
              ...
              style={{
                ...fieldBase,
                borderColor: hasChanged("packageName")
                  ? theme.primary
                  : theme.border,
                backgroundColor: hasChanged("packageName")
                  ? `${theme.primary}10`
                  : theme.background,
              }}
          ...
          <motion.div variants={fieldVariants} className="lg:col-span-2">
            ...
            <textarea
              ...
              onChange={(e) =>
                onFieldChange("packageDescription", e.target.value)
              }
              rows={4}
              className="w-full px-4 py-2.5 rounded-xl border-2 focus:outline-none text-sm resize-none"
              style={{
                ...fieldBase,
                borderColor: hasChanged("packageDescription")
                  ? theme.primary
                  : theme.border,
                backgroundColor: hasChanged("packageDescription")
                  ? `${theme.primary}10`
                  : theme.background,
              }}
          ...
          <motion.div variants={fieldVariants}>
            ...
            <select
              ...
              style={{
                ...fieldBase,
                borderColor: hasChanged("packageTypeName")
                  ? theme.primary
                  : theme.border,
              }}
            ...
            >
              ...
              {availablePackageTypes.map((type) => (
                <option
                  key={type.packageCategoryId}
                  value={type.packageCategoryName}
                >
          ...
          <motion.div variants={fieldVariants}>
            ...
            <select
              ...
              onChange={(e) =>
                onFieldChange("tourId", parseInt(e.target.value))
              }
              className="w-full px-4 py-2.5 rounded-xl border-2 focus:outline-none text-sm cursor-pointer"
              style={{
                ...fieldBase,
                borderColor: hasChanged("tourId")
                  ? theme.primary
                  : theme.border,
              }}
          ...
          <motion.div variants={fieldVariants}>
            ...
            <input
              ...
              style={{
                ...fieldBase,
                borderColor: hasChanged("startDate")
                  ? theme.primary
                  : theme.border,
              }}
          ...
          <motion.div variants={fieldVariants}>
            ...
            <input
              ...
              style={{
                ...fieldBase,
                borderColor: hasChanged("endDate")
                  ? theme.primary
                  : theme.border,
              }}
          ...
          <motion.div variants={fieldVariants}>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) =>
                  onFieldChange("totalPrice", parseFloat(e.target.value))
                }
                className="w-full pl-8 pr-4 py-2.5 rounded-xl border-2 focus:outline-none text-sm"
                style={{
                  ...fieldBase,
                  borderColor: hasChanged("totalPrice")
                    ? theme.primary
                    : theme.border,
                }}
          ...
          <motion.div variants={fieldVariants}>
            ...
            <div className="relative">
              <input
                ...
                style={{
                  ...fieldBase,
                  borderColor: hasChanged("discountPercentage")
                    ? theme.primary
                    : theme.border,
                }}
            ...
            {packageData.discountPercentage > 0 && (
              <p className="text-xs mt-1" style={{ color: theme.success }}>
                Discount: $
                {(
                  (packageData.totalPrice * packageData.discountPercentage) /
                  100
                ).toFixed(2)}
              </p>
            )}
          ...
          <motion.div variants={fieldVariants}>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) =>
                  onFieldChange("pricePerPerson", parseFloat(e.target.value))
                }
                className="w-full pl-8 pr-4 py-2.5 rounded-xl border-2 focus:outline-none text-sm"
                style={{
                  ...fieldBase,
                  borderColor: hasChanged("pricePerPerson")
                    ? theme.primary
                    : theme.border,
                }}
          ...
          <motion.div variants={fieldVariants}>
            ...
            <input
              ...
              onChange={(e) =>
                onFieldChange("minPersonCount", parseInt(e.target.value))
              }
              className="w-full px-4 py-2.5 rounded-xl border-2 focus:outline-none text-sm"
              style={{
                ...fieldBase,
                borderColor: hasChanged("minPersonCount")
                  ? theme.primary
                  : theme.border,
              }}
          ...
          <motion.div variants={fieldVariants}>
            ...
            <input
              ...
              onChange={(e) =>
                onFieldChange("maxPersonCount", parseInt(e.target.value))
              }
              className="w-full px-4 py-2.5 rounded-xl border-2 focus:outline-none text-sm"
              style={{
                ...fieldBase,
                borderColor: hasChanged("maxPersonCount")
                  ? theme.primary
                  : theme.border,
              }}
              ...
              {PACKAGE_UPDATE_PRESET_COLORS.map((color) => (
                <button
                  ...
                  style={{
                    ...
                    borderColor:
                      packageData.color === color ? theme.text : "transparent",
                    boxShadow:
                      packageData.color === color
          ...
          <motion.div variants={fieldVariants}>
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                style={{
                  ...fieldBase,
                  borderColor: hasChanged("hoverColor")
                    ? theme.primary
                    : theme.border,
                }}
                placeholder="#000000"
          ...
          <motion.div variants={fieldVariants} className="lg:col-span-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              {PACKAGE_UPDATE_STATUS_OPTIONS.map((opt) => {
