// components/tours-components/terminate-tour-components/SchedulesList.tsx
"use client";

import React, { useState } from "react";
import { motion, AnimatePresence, type Variants } from "framer-motion";
import { Calendar, ChevronDown, Clock, FileText, Info } from "lucide-react";
import { Schedule } from "@/types/tour-types";
                    ...
                    <div className="grid gap-2 mt-2">
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-1 pt-1 border-t" style={{ borderColor: hexToRgba(theme.border, 0.5) }}>
                        <div>
                          ...
                          <p className="text-xs" style={{ color: theme.text }}>{formatDate(schedule.assumeStartDate)}</p>
                        </div>
                        <div>
                          <p className="text-[10px]" style={{ color: theme.textSecondary }}>End Date</p>
                          <p className="text-xs" style={{ color: theme.text }}>{formatDate(schedule.assumeEndDate)}</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
