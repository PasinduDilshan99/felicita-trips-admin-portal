...
export const LocationMap: React.FC<LocationMapProps> = ({ location, latitude, longitude }) => {
  ...
  return (
    ...
    >
      ...
      <div className="mb-3.5 rounded-xl overflow-hidden h-[200px] border" style={{ borderColor: theme.border }}>
        <iframe
