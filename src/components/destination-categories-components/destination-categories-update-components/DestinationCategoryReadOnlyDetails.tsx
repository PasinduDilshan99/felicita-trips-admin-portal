...
import { DestinationCategoryReadOnlyDetailsProps } from "@/types/destination-category-types";
import { cardVariants, sectionVariants } from "@/app/animations/variants";

export const DestinationCategoryReadOnlyDetails: React.FC<
  DestinationCategoryReadOnlyDetailsProps
> = ({
  category,
  expandedSections,
  onToggleSection,
  ...
  const primaryDestination = category.destinations.find((d) => d.primary);
  const otherDestinations = category.destinations.filter((d) => !d.primary);
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <button
          onClick={() => onToggleSection("destinations")}
          className="w-full flex items-center justify-between p-4 cursor-pointer transition-colors"
          style={{
            backgroundColor: expandedSections.has("destinations")
              ? `${theme.primary}05`
              : "transparent",
            borderBottom: expandedSections.has("destinations")
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              >
                Read-only destination list ({category.destinations.length}{" "}
                destinations)
              </p>
            </div>
          </div>
          <ChevronDown
            ...
            style={{
              transform: expandedSections.has("destinations")
                ? "rotate(180deg)"
                : "none",
                ...
                <div className="mb-4">
                  ...
                  >
                    <div>
                      ...
                      {primaryDestination.destinationDescription && (
                        <p
                          className="text-xs mt-1 opacity-75"
                          style={{ color: theme.textSecondary }}
                        >
                          {primaryDestination.destinationDescription.length >
                          100
                            ? `${primaryDestination.destinationDescription.substring(0, 100)}...`
                            : primaryDestination.destinationDescription}
                        </p>
                      )}
                    </div>
              ...
              {otherDestinations.length > 0 && (
                <div>
                  <h3
                    ...
                    style={{ color: theme.textSecondary }}
                  >
                    Other Destinations ({otherDestinations.length})
                  </h3>
                        ...
                        <div>
                          ...
                          {destination.destinationDescription && (
                            <p
                              ...
                              style={{ color: theme.textSecondary }}
                            >
                              {destination.destinationDescription.length > 100
                                ? `${destination.destinationDescription.substring(0, 100)}...`
                                : destination.destinationDescription}
                            </p>
                          )}
                        </div>
