...
import { FileText, AlertCircle, CheckCircle2, Sparkles } from "lucide-react";
...
const CategoryBasicInfoForm: React.FC<CategoryBasicInfoFormProps> = ({
  category,
  description,
  status,
  errors,
...
// Import AnimatePresence for the status button animation
