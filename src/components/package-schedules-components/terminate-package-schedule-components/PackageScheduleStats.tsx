// components/package-schedules-components/terminate-package-schedule-components/PackageScheduleStats.tsx
"use client";

import React from "react";
import { motion, type Variants } from "framer-motion";
import { Calendar, Clock, DollarSign, Users, Hotel, Gift, AlertCircle, Percent } from "lucide-react";
...
interface PackageScheduleStatsProps {
...
export const PackageScheduleStats: React.FC<PackageScheduleStatsProps> = ({ scheduleDetails }) => {
  ...
  const statItems: StatItem[] = [
    ...
    {
      label: "Total Price",
      value: scheduleDetails.totalPrice,
    ...
    },
    {
      ...
      value: scheduleDetails.pricePerPerson,
      icon: <Users size={14} />,
      color: theme.primary,
      formatter: (val) => formatPrice(val as number),
    },
    {
      label: "Group Size",
      value: `${scheduleDetails.minPersonCount}–${scheduleDetails.maxPersonCount}`,
      icon: <Users size={14} />,
      color: theme.accent,
      formatter: (val) => val,
    },
    {
      label: "Features",
      value: scheduleDetails.features.length,
      icon: <Gift size={14} />,
      color: theme.success,
      formatter: (val) => val,
    },
    ...
    },
    {
      ...
      value: scheduleDetails.packageStatus || "Unknown",
      icon: <AlertCircle size={14} />,
      color: getStatusColor(scheduleDetails.packageStatus),
      formatter: (val) => val,
    },
  ];
        ...
        {statItems.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              {(item.label === "Schedule Status" || item.label === "Package Status") && (
                <motion.div
