...
import {
  PackageScheduleFeature,
  PackageScheduleAccommodation,
  PackageScheduleReadOnlyDetailsProps,
...
export const PackageScheduleReadOnlyDetails: React.FC<
  PackageScheduleReadOnlyDetailsProps
> = ({ schedule, expandedSections, onToggleSection }) => {
      ...
      >
        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <InfoCard
              label="Package Type"
              value={schedule.packageTypeName}
              theme={theme}
            />
            <InfoCard label="Tour" value={schedule.tourName} theme={theme} />
            <InfoCard
              label="Tour Schedule"
              value={schedule.tourScheduleName || "Not assigned"}
              theme={theme}
            />
            <InfoCard
      ...
      {schedule.features && schedule.features.length > 0 && (
        ...
        >
          <button
            ...
            style={{
              backgroundColor: expandedSections.has("features")
                ? `${theme.warning}05`
                : "transparent",
              borderBottom: expandedSections.has("features")
          ...
          >
            ...
            <ChevronDown
              ...
              style={{
                transform: expandedSections.has("features")
                  ? "rotate(180deg)"
                  : "none",
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p
                  ...
                  style={{ color: theme.textSecondary }}
                >
                  Read-only accommodation details (
                  {schedule.accommodations.length} days)
                </p>
              </div>
            </div>
            <ChevronDown
  ...
  >
    ...
    <div className="p-4 space-y-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-center">
        <PriceCard
          label="Local Price"
          value={formatPrice(acc.localPrice)}
          theme={theme}
        />
        <PriceCard
          label="Price"
          value={formatPrice(acc.price)}
          theme={theme}
          highlight
        />
        <PriceCard
          label="Transport Cost"
          value={formatPrice(acc.transportCost)}
          theme={theme}
        />
        <div
      ...
      {acc.extraChargeNote && (
        ...
        >
          <p className="text-xs">
            Extra Charge: {formatPrice(acc.extraCharge)} - {acc.extraChargeNote}
          </p>
        </div>
      )}
    </div>
