// components/tour-schedules-components/terminate-tour-schedule-components/CategoriesList.tsx
"use client";
            ...
            >
              ...
              >
                <div className="flex items-center gap-1.5">
                  {category.primaryCategory && <Star size={12} className="text-yellow-300" />}
