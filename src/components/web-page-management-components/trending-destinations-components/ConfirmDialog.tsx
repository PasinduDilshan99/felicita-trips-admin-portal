...
export const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  const getIcon = () => {
    switch (type) {
      case "danger":
        return <AlertCircle className="w-6 h-6" style={{ color: theme.error }} />;
      case "success":
        return <CheckCircle className="w-6 h-6" style={{ color: theme.success }} />;
      case "info":
        return <Info className="w-6 h-6" style={{ color: theme.primary }} />;
      case "warning":
      default:
        return <AlertTriangle className="w-6 h-6" style={{ color: theme.warning }} />;
    }
  };
              ...
              >
                <motion.button
                  ...
                  onMouseEnter={(e) => {
                    if (!isLoading) {
                      ...
                      e.currentTarget.style.backgroundColor = hexToRgba(getHeaderColor(), 0.05);
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    boxShadow: `0 4px 12px ${hexToRgba(getButtonColor(), 0.3)}`,
                  }}
                >
