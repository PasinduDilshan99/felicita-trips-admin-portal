// components/activity-categories-components/view-category-details-components/CategoryGalleryMini.tsx
"use client";
...
interface CategoryGalleryMiniProps {
...
export const CategoryGalleryMini: React.FC<CategoryGalleryMiniProps> = ({
  images,
  onImageClick,
  onViewAll,
}) => {
        ...
        <div className="grid grid-cols-2 gap-2">
          {displayImages.map((img, idx) => (
            ...
            >
              <img
                src={img.imageUrl}
                alt={img.imageName || `Gallery image ${idx + 1}`}
