// components/activity-categories-components/activity-category-details-view-components/ActivityCategoryOverview.tsx
"use client";
...
interface ActivityCategoryOverviewProps {
  name: string;
  description: string;
  color: string;
  hoverColor: string;
...
export const ActivityCategoryOverview: React.FC<ActivityCategoryOverviewProps> = ({
  name,
  description,
  color,
  hoverColor,
