  ...
  return (
    <>
      <style>{`
        ...
        @media (max-width: 460px)  { .ap-stats-grid { grid-template-columns: 1fr; } }
        ...
        .ap-stat-card--blue::after    { background: radial-gradient(circle, ${hexToRgba("#3b82f6", 0.12)}, transparent 70%); }
        .ap-stat-card--emerald::after { background: radial-gradient(circle, ${hexToRgba("#10b981", 0.12)}, transparent 70%); }
        .ap-stat-card--rose::after    { background: radial-gradient(circle, ${hexToRgba("#f43f5e", 0.12)}, transparent 70%); }
        .ap-stat-card--violet::after  { background: radial-gradient(circle, ${hexToRgba("#8b5cf6", 0.12)}, transparent 70%); }
        .ap-stat-card--amber::after   { background: radial-gradient(circle, ${hexToRgba("#f59e0b", 0.12)}, transparent 70%); }
        .ap-stat-card--teal::after    { background: radial-gradient(circle, ${hexToRgba("#14b8a6", 0.12)}, transparent 70%); }
        ...
        @media (max-width: 860px) { .ap-charts-row { grid-template-columns: 1fr; } }
        ...
        .ap-chart-dot--ok { background: var(--ok); }
        .ap-chart-sub {
          font-size: .75rem;
          color: var(--muted);
          font-weight: 600;
        ...
        <div>
          ...
          {loading ? (
            <div className="ap-loading">
              ...
              <span className="ap-loading-text">Loading activity data…</span>
                  ...
                  <section className="ap-mt-8">
                    ...
                    <div className="ap-charts-row">
                      ...
                      <div className="ap-chart-card">
                        <div className="ap-chart-header">
                          <div className="ap-chart-title">
                            <span className="ap-chart-dot ap-chart-dot--ok" />
              ...
              <Reveal delay={240}>
                <section className="ap-mt-7">
                  <div className="ap-info-banner">
                    ...
                    <div>
                      <p className="ap-info-title">Activity Management</p>
                      <p className="ap-info-text">
                        ...
                        be categorized by type, difficulty level, and duration. Statistics and charts reflect the latest
                        data from your backend and update each time you visit this page.
                      </p>
                    </div>
                  </div>
                </section>
