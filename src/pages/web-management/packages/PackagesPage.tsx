...
const PackagesPage = () => {
  // Get packages data from sidebar data
  ...
  return (
    <div className="bg-slate-100">
      <div className="mx-auto">
        ...
        <PageHeader
          title="Packages"
          description="Manage travel packages and bundled services"
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Featured Packages</p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">
                Use the cards above to manage your travel packages. You can view all packages, 
                add new bundled packages, update existing package information, or remove packages 
                that are no longer available. Packages can include combinations of tours, 
                accommodations, and activities at special rates.
              </p>
            </div>
          </div>
        </div>
