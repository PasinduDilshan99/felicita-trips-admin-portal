...
const CustomPieTooltip = ({ active, payload }: any) => {
  ...
  return (
    <div className="ap-tooltip">
      ...
      <p className="ap-tooltip__value">{payload[0].value.toLocaleString()} packages</p>
    </div>
  );
};
...
const PackageTypesPage = () => {
  ...
  // Process participation trend data (group by month if needed)
        ...
        <div>
          ...
          {loading ? (
            <div className="ap-loading">
              ...
              <span className="ap-loading-text">Loading package type data…</span>
                      ...
                      <div className="ap-charts-grid">
                        ...
                        <div className="ap-chart-card">
                          ...
                          {revenueData.length > 0 ? (
                            ...
                            <div className="ap-empty-state">
                              <p className="ap-empty-text">No revenue data available</p>
                            </div>
                          )}
                        </div>
                      </div>
              ...
              <Reveal delay={360}>
                <section className="ap-mt-7">
                  <div className="ap-info-banner">
                    ...
                    <div>
                      <p className="ap-info-title">Package Type Management</p>
                      <p className="ap-info-text">
                        Manage package types and analyze their performance. Track type distribution, revenue performance,
                        booking metrics, ratings, and usage patterns. Types help categorize packages by travel style,
                        duration, and interests. Use the quick actions above to add, edit, or remove package types.
                        The line chart shows participation trends over time, while the stacked bar shows primary vs
