...
const CustomColumnTooltip = ({ active, payload, label }: any) => {
  if (!active || !payload?.length) return null;
  const data = payload[0]?.payload;
  if (!data) return null;
  return (
    <div className="ap-tooltip">
      <p className="ap-tooltip__label">Duration Range</p>
      <p className="ap-tooltip__value">
...
const CustomParticipationTooltip = ({ active, payload, label }: any) => {
  ...
  const lineValue = payload[1]?.value || 0;
  return (
    <div className="ap-tooltip">
      <p className="ap-tooltip__label">{label}</p>
      <p className="ap-tooltip__value">
      ...
      {lineValue > 0 && (
        <p className="ap-tooltip__sub">Trend: {lineValue.toLocaleString()}</p>
      )}
    </div>
  );
};
...
const ToursSchedulesPage = () => {
  ...
  // Prepare participation trend data (combining with schedule names)
                      ...
                      <div className="ap-charts-grid">
                        ...
                        <div className="ap-chart-card">
                          <div className="ap-chart-header">
                            ...
                            <span className="ap-chart-sub">Over time</span>
                          </div>
                              ...
                              <ResponsiveContainer width="100%" height="100%">
                                ...
                                >
                                  ...
                                  <YAxis
                                    ...
                                    width={35}
                                  />
                                  <Tooltip content={<CustomColumnTooltip />} />
                                  <Bar
                                    dataKey="totalSchedules"
              ...
              <Reveal delay={360}>
                <section className="ap-mt-7">
                  <div className="ap-info-banner">
                    ...
                    <div>
                      <p className="ap-info-title">Tour Schedule Management</p>
                      <p className="ap-info-text">
                        Manage tour schedules, track timeline trends, analyze
                        duration distributions, and monitor execution
                        performance. The participation trend chart shows
                        participant engagement across different schedules. Use
                        the quick actions above to create new schedules, update
                        existing ones, or remove outdated schedules. Statistics
                        and charts reflect real-time data from your backend and
                        update each time you visit this page.
                      </p>
                    </div>
                  </div>
                </section>
