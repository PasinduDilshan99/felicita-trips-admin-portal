...
const CustomBubbleTooltip = ({ active, payload }: any) => {
  ...
  return (
    <div className="ap-tooltip">
      <p className="ap-tooltip__label">{data.typeName}</p>
      <p className="ap-tooltip__value">
        ...
        <div>
          ...
          {loading ? (
            <div className="ap-loading">
              ...
              <span className="ap-loading-text">Loading type data…</span>
              ...
              <Reveal delay={360}>
                <section className="ap-mt-7">
                  <div className="ap-info-banner">
                    ...
                    <div>
                      <p className="ap-info-title">Tour Type Management</p>
                      <p className="ap-info-text">
                        Manage tour types and analyze their performance. Track type distribution, booking metrics,
                        ratings, and usage patterns. Types help categorize tours by experience level, duration,
                        and activity style. Use the quick actions above to add, edit, or remove types. The bubble chart
                        shows the relationship between number of tours, average rating, and participant impact for each type.
                      </p>
                    </div>
                  </div>
                </section>
