...
const AddNewTourCategoryPage = () => {
  ...
  const handleImagesChange = (images: TourCategoryImageRequest[]) => {
  ...
  // Submit tour category
  const submitTourCategory = async () => {
    setLoading(true);
    try {
      const response = await TourCategoryService.addTourCategory(formData);
      if (response.code === 200) {
        setToast({
          show: true,
          type: "success",
          title: "Tour Category Created Successfully!",
          message: `${formData.categoryName} has been added to tour categories.`,
        });
        handleReset();
        return response;
      } else {
        throw new Error(response.message || "Failed to add tour category");
      }
    } catch (error: any) {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      Basic details for the tour category
                    </p>
                  </div>
                </div>
                ...
                <div className="px-6 py-6 space-y-6">
                  <InputField
                    ...
                    required
                    placeholder="e.g., Adventure, Cultural, Wildlife, Beach"
                    maxLength={100}
                    showCounter
          ...
          <div className="space-y-8">
            {/* Image Uploader */}
            <ImageUploader<TourCategoryImageRequest>
            ...
            <FormSummary
              ...
              tips={[
                ...
                "Add relevant tours to this category for better organization",
                "Upload representative images for better visualization",
                "Inactive categories won't be visible to customers",
                "Categories help customers filter and find tours easily",
              ]}
            />
          </div>
        </div>
      ...
      <CreateConfirmationDialog
        ...
        details={{
          title: "Create New Tour Category",
          message: "Are you sure you want to create this tour category?",
        ...
        cancelText="Cancel"
        onSuccess={() => {
          console.log("Tour category created successfully");
          // Optional: Redirect after success
          // setTimeout(() => {
          //   router.push(`${WEB_MANAGEMENT_PATH}${WEB_MANAGEMENT_DESTINATION_PATH}/tour-categories`);
          // }, 1500);
        }}
        onError={(error) => {
          ...
          setToast({
            ...
            message:
              error.message ||
              "Failed to create tour category. Please try again.",
          });
        }}
      />
    </div>
...
export default AddNewTourCategoryPage;
