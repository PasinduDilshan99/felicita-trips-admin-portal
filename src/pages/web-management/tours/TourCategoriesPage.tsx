...
const CustomPieTooltip = ({ active, payload }: any) => {
  ...
  return (
    <div className="ap-tooltip">
      ...
      <p className="ap-tooltip__value">{payload[0].value.toLocaleString()} tours</p>
    </div>
  );
};
...
const CustomBarTooltip = ({ active, payload, label }: any) => {
  ...
  return (
    <div className="ap-tooltip">
      ...
      <p className="ap-tooltip__value">{payload[0].value.toLocaleString()} bookings</p>
    </div>
  );
};
...
const TourCategoriesPage = () => {
  ...
  const maxParticipants = Math.max(...bubbleData.map(d => d.totalParticipants), 0);
  const maxTours = Math.max(...bubbleData.map(d => d.totalTours), 0);
                      ...
                      <div className="ap-charts-grid">
                        ...
                        <div className="ap-chart-card">
                          ...
                          {pieChartData.length > 0 ? (
                            ...
                            <div className="ap-empty-state">
                              <p className="ap-empty-text">No distribution data available</p>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="ap-chart-card">
                          ...
                          {barChartData.length > 0 ? (
                            ...
                            <div className="ap-empty-state">
                              <p className="ap-empty-text">No booking data available</p>
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="ap-chart-card">
                        ...
                        {bubbleData.length > 0 ? (
                          <>
                            ...
                            <div className="ap-bubble-legend">
                              <div className="ap-bubble-legend-item">
                                <div className="ap-bubble-legend-dot" />
                                <span>Smaller bubble = Fewer participants</span>
                              </div>
                              <div className="ap-bubble-legend-item">
                                <div className="ap-bubble-legend-dot ap-bubble-legend-dot--large" />
              ...
              <Reveal delay={360}>
                <section className="ap-mt-7">
                  <div className="ap-info-banner">
                    ...
                    <div>
                      <p className="ap-info-title">Tour Category Management</p>
                      <p className="ap-info-text">
                        Manage tour categories and analyze their performance. Track category distribution, booking metrics,
                        ratings, and usage patterns. Categories help organize tours by type, difficulty, and interests.
                        Use the quick actions above to add, edit, or remove categories. The bubble chart shows the relationship
                        between number of tours, average rating, and participant impact for each category.
                      </p>
                    </div>
                  </div>
                </section>
