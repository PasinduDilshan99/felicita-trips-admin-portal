...
const RolesPage = () => {
  ...
  const fetchStatistics = async () => {
    try {
      ...
      setError(null);
      setStatistics(null);
      const response = await RoleService.getRolesStatistics();
  ...
  // Area chart data for user activity (Updates, Creates, Terminations)
  const getUserActivityMap = () => {
    ...
    // Add updates (filter out null usernames)
  ...
  // Bar chart data for role usage (Top roles by user count)
  const getBarChartData = () => {
    if (!statistics?.roleUsages) return [];
    return statistics.roleUsages
      .sort((a, b) => b.userCount - a.userCount)
      .slice(0, 10)
      .map((item) => ({
        name:
          item.roleName.length > 15
  ...
  // Pie chart data for role status distribution
  const pieChartData = statistics
    ? [
        {
          name: "Active",
          value: statistics.roleDetails.activeCount,
          color: "#10b981",
        },
        {
          name: "Inactive",
          value: statistics.roleDetails.inActiveCount,
          color: "#f59e0b",
        },
        {
          name: "Hidden",
          value: statistics.roleDetails.hiddenCount,
          color: "#ef4444",
        },
      ]
    : [];
  ...
  const statCards: StatCard[] = statistics
    ? [
        {
          title: "Total",
          value: statistics.roleDetails.totalCount,
          accent: "blue",
          icon: (
            <svg
              viewBox="0 0 24 24"
        ...
        },
        {
          ...
          value: statistics.roleDetails.recentlyUpdateCount,
          accent: "teal",
          icon: (
            <svg
              viewBox="0 0 24 24"
        ...
        },
        {
          ...
          value: statistics.roleDetails.recentlyAddedCount,
          accent: "violet",
          icon: (
            <svg
              viewBox="0 0 24 24"
        ...
        <div>
          ...
          {loading ? (
            <div className="dp-loading">
              ...
              <span className="dp-loading-text">Loading role data…</span>
            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <Reveal delay={60}>
                <section>
                  <SectionHeader
                    title="Quick Actions"
                    subtitle="Jump directly to any role management task"
                    badge={`${rolesData?.subData.length ?? 0} actions`}
                  />
                  <div className="dp-actions-grid">
                    {loading
                      ...
                      : rolesData?.subData.map((action, idx) => {
                ...
                <Reveal delay={120}>
                  <section className="dp-mt-8">
                    <SectionHeader
                      ...
                      subtitle="Live counts across all role records"
                      badge="Live"
                      live
                    />
                ...
                <Reveal delay={180}>
                  <section className="dp-mt-8">
                    <SectionHeader
                      ...
                      subtitle="Role distribution, user assignment, and activity trends"
                    />
                    <div className="dp-charts-row">
                      ...
                      <div className="dp-chart-card">
                        <div className="dp-chart-header">
                          <div className="dp-chart-title">
                            ...
                            User Role Activity Trends
                          </div>
                          <span className="dp-chart-sub">
                            Top {areaChartData.length} users
                          </span>
                        </div>
                        {areaChartData.length > 0 ? (
                          ...
                          <div
                            ...
                            style={{ height: 320, color: textSecondary }}
                          >
                      ...
                      {/* Bar Chart — Role Usage */}
                      <div className="dp-chart-card">
                        <div className="dp-chart-header">
                          <div className="dp-chart-title">
                            <span className="dp-chart-dot dp-chart-dot--ok" />
                            Role Usage by User Assignment
                          </div>
                          <span className="dp-chart-sub">
                            Top {barChartData.length} roles
                          </span>
                        </div>
                        {barChartData.length > 0 ? (
                          ...
                          <div
                            className="flex items-center justify-center"
                            style={{ height: 360, color: textSecondary }}
                          >
                    ...
                    {/* Pie Chart — Role Status Distribution (Full width) */}
                    <div className="dp-chart-card dp-mt-6">
                      <div className="dp-chart-header">
                        <div className="dp-chart-title">
                          <span className="dp-chart-dot dp-chart-dot--p" />
                        ...
                        <span className="dp-chart-sub">
                          {statistics.roleDetails.totalCount} total roles
                        </span>
                      </div>
              ...
              <Reveal delay={240}>
                <section className="dp-mt-7">
                  <div className="dp-info-banner">
                    ...
                    <div>
                      <p className="dp-info-title">Role Management</p>
                      <p className="dp-info-text">
                        Use the quick-action cards above to browse, create,
                        edit, or remove roles. The area chart shows user
                        activity trends across role operations, the bar chart
                        displays role usage by user assignment, and the pie
                        chart shows the distribution of role statuses. All
                        statistics reflect the latest data from your backend.
                      </p>
                    </div>
                  </div>
                </section>
