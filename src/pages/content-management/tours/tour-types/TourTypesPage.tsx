...
const TourTypesPage = () => {
  ...
  const [statistics, setStatistics] = useState<TourTypeStatisticsData | null>(
    null,
  );
  ...
  const bubbleData =
    statistics?.typeParticipationImpact.map((impact) => {
