...
import ActivityDetailsPage from "@/pages/web-management/activities/ActivityDetailsPage";
import DestinationDetailsPage from "@/pages/web-management/destinations/DestinationDetailsPage";
import TourDetailsViewPage from "@/pages/web-management/tours/TourDetailsViewPage";
