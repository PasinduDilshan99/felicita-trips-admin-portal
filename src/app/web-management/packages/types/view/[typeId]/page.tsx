...
import PackageTypeDetailsViewPage from "@/pages/web-management/packages/package-types/PackageTypeDetailsViewPage";
import PackageDetailsViewPage from "@/pages/web-management/packages/PackageDetailsViewPage";
